...
from PetBook.core.views import core
from PetBook.users.views import users
from PetBook.pet_posts.views import pet_posts
from PetBook.error_pages.handlers import error_pages

# Register the apps
app.register_blueprint(users)
app.register_blueprint(pet_posts)
